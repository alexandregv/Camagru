  ...
  <section class="section">
	<div class="container">
		<div class="columns is-centered">
			<form id="form" method="POST" action="<?= Helpers::route('Users#register') ?>" class="box column is-one-third">
				<div class="field">
				...
				<div class="field">
				  ...
				  <div class="control has-icons-left has-icons-right">
						<input id="password" type="password" name="password" class="input <?php if (array_search('invalid_password', $this->errors) !== false) echo 'is-danger'; ?>" placeholder="cNiL-Pr00f">
				...
				<div class="field">
				  ...
				  <div class="control has-icons-left has-icons-right">
						<input id="password-confirm" type="password" name="password_confirm" class="input <?php if (array_search('invalid_password_confirmation', $this->errors) !== false || array_search('passwords_mismatch', $this->errors) !== false) echo 'is-danger'; ?>" placeholder="cNiL-Pr00f">
						<span class="icon is-small is-left"><i class="fas fa-key"></i></span>
				  </div>
				...
				<div class="field is-grouped">
					<div class="control"><button type="button" onclick="register();"class="button is-link">Inscription</button</div>
...
function register()
{
	document.querySelector('#password').value = hex_sha512('grumaca' + document.querySelector('#password'));
	document.querySelector('#password-confirm').value = hex_sha512('grumaca' + document.querySelector('#password'));
